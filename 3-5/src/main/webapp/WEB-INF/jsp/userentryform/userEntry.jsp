...
<table>
	<tr height="40px"><td>가입자ID</td><td><form:input path="userId" 
		maxLength="20" cssClass="userId"/>
		<font color="red"><form:errors path="userId"/></font></td></tr>
	<tr height="40px"><td>암 호</td><td><form:password path="password" 
		maxLength="20" cssClass="password"/>
		<font color="red"><form:errors path="password"/></font></td></tr>
	<tr height="40px"><td>이 름</td><td><form:input path="userName" 
		maxLength="30" cssClass="userName"/>
		<font color="red"><form:errors path="userName"/></font></td></tr>
	<tr height="40px"><td>주 소</td><td><form:input path="address" 
	...
	<tr height="40px"><td>직업</td><td>
		<form:select path="job"	cssClass="job">
...
<table>
	<tr><td height="40px" align="center">
		...
		<input type="reset" value="취소" name="btnReset"/></td></tr>
</table>
</form:form>
