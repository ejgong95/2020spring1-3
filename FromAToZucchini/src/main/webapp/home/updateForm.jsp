...
<form:form action="../write/updateDo.html" method="post" enctype="multipart/form-data"
	onSubmit="return validate(this)" modelAttribute="writing">
...
<tr><td>이미지</td><td><input type="file" name="image"/><br/>
	<img alt="" src="${pageContext.request.contextPath }/upload/${writing.image_name }" width="350" height="350"
			border="0"></td></tr>
<tr><td>글내용</td><td>
	<form:textarea rows="8" cols="40" path="content" value="${writing.content}"></form:textarea>
	</td></tr>
