...
<form:form action="../product/entry.html" method="post"
	...
	<fieldset>
		...
		원산지 : <form:select path="origin">
				<form:option value="한국"></form:option>
				<form:option value="일본"></form:option>
				<form:option value="중국"></form:option>
				<form:option value="배트남"></form:option>
				<form:option value="태국"></form:option>
				<form:option value="기타"></form:option>
				
		</form:select><br/>
		상품설명(아래) : <br/>
		<form:textarea rows="5" cols="80" path="info"></form:textarea><br/>
	</fieldset>	
